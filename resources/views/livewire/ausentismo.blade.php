...
>
    ...
    <div class="flex flex-col md:flex-row md:items-end md:justify-between gap-3">
        ...
        <div class="flex items-center gap-2">
            <input type="text" wire:model.debounce.500ms="q"
                   placeholder="Buscar (nombre, cargo, observación)"
                   class="w-72 px-3 py-2 border rounded-md border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" />
            <select wire:model="perPage"
                    class="px-2 py-2 border rounded-md border-gray-300 text-sm">
    ...
    <div id="ausentismo-form" class="bg-white rounded-2xl shadow p-4 md:p-6">
        ...
        <form wire:submit.prevent="{{ $this->editingId ? 'update' : 'create' }}" class="grid grid-cols-1 md:grid-cols-12 gap-3">
            {{-- Nombre --}}
            <div class="md:col-span-4">
                ...
                <input type="text" wire:model.defer="funcionario_nombre" required minlength="3" maxlength="150"
                       class="w-full px-3 py-2 border rounded-md border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('funcionario_nombre') ring-2 ring-red-500 @enderror">
            ...
            <div class="md:col-span-3">
                ...
                <select wire:model.defer="cargo" required
                        class="w-full px-3 py-2 border rounded-md border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('cargo') ring-2 ring-red-500 @enderror">
            ...
            <div class="md:col-span-2">
                ...
                <input type="date" wire:model.defer="fecha_inicio" required
                       class="w-full px-3 py-2 border rounded-md border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('fecha_inicio') ring-2 ring-red-500 @enderror">
            ...
            <div class="md:col-span-2">
                ...
                <input type="date" wire:model.defer="fecha_termino" required
                       class="w-full px-3 py-2 border rounded-md border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('fecha_termino') ring-2 ring-red-500 @enderror">
