<x-in-layout>
                        <div class="grid gap-6 pt-5 mb-6 lg:grid-cols-1 lg:gap-8 animate__animated animate__backInUp animate__delay-0.5s">
                        ...
                        <div class="grid gap-6 lg:grid-cols-1 lg:gap-8 animate__animated animate__backInUp animate__delay-0.8s">
