<x-in-layout>
    {{-- Tarjeta encabezado + icono --}}
    <div class="grid gap-6 pt-5 mb-6 lg:grid-cols-1 lg:gap-8
                animate__animated animate__fadeInDown"
         style="--animate-duration: 600ms; --animate-delay: .05s;">
        <div class="absolute top-4 left-4">
            <a href="{{ url('/') }}"
               class="bg-white text-black font-semibold py-1 px-3 rounded-md shadow-md flex items-center text-sm
        ...
        <div class="flex justify-center items-start gap-4 rounded-lg bg-white p-6
    ...
    {{-- Calendario (entra después, de abajo hacia arriba) --}}
    <div class="grid gap-6 lg:grid-cols-1 lg:gap-8
                animate__animated animate__fadeInUp"
         style="--animate-duration: 580ms; --animate-delay: .22s;">
        <div class="flex flex-col gap-6 overflow-hidden rounded-lg bg-white p-6
                    shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05]
                    lg:p-10 lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800">
