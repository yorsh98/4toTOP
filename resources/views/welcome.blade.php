                    ...
                    <div class="grid gap-6 pt-1 mb-6 lg:grid-cols-1 lg:gap-8">
                                ...
                                <div class="relative flex items-center gap-6 lg:items-end">
                                    ...
                                    <div class="!pt-0">
                                        ...
                                        <p class="mt-4 text-sm/relaxed">
                                            PRESIONE SOBRE EL SISTEMA A UTILIZAR 👆🏻
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <a  id="2"
                                    ...
                                    <div class="overflow-hidden break-words">
                                        <h2 class="text-xl font-semibold text-black">GUIAS TELEFONICAS</h2>
                        ...
                        <div class="grid gap-6 pt-6 lg:grid-cols-2 lg:gap-8">
                            <div class="flip-container " onclick="toggleFlip(this)">
                                ...
                                <a  id="7" class="flex back overflow-hidden break-words items-center justify-center gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]">
                                     <!-- Columna 1 -->
                                     <div class="space-y-2 ">
                            ...
                            <div class="flip-container" onclick="toggleFlip(this)">
                                ...
                                <a  id="7" class="flex overflow-hidden break-words back items-center justify-center gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]">
                                     <!-- Columna 1 -->
                                    <div class="space-y-2">
                                        <h3 class="text-lg font-semibold text-[#FF2D20] border-b pb-1 mb-2">MAGISTRADOS</h3>
                                        <ul class="space-y-1">
                        ...
                        <div class="grid gap-6 pt-6 lg:grid-cols-3 lg:gap-8">
                            ...
                            <a
                                ...
                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black dark:text-white">MIGRACION UNIJUD</h2>

                                    <p class="mt-4 text-sm/relaxed">
                                        LISTADO DE TRIBUNALES MIGRADOS A UNIJUD
                                    </p>
                                </div>
